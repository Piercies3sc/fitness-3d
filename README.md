...
| 3D Anatomy (Front View) | 3D Anatomy (Muscle Selected) |
| :---: | :---: |
| ![3D Anatomy Front](docs/screenshots/body_3d_front.png) | ![3D Anatomy Selected](docs/screenshots/body_3d_selected_muscle.png) |

| 3D Anatomy (Back View) | Exercise Catalog |
| :---: | :---: |
| ![3D Anatomy Back](docs/screenshots/body_3d_back.png) | ![Exercise Catalog](docs/screenshots/exercises_catalog.png) |

| Exercise Details | Authentication |
| :---: | :---: |
| ![Exercise Detail](docs/screenshots/exercise_detail.png) | ![Authentication](docs/screenshots/auth_login.png) |
